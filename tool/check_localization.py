...
base = json.loads((root / 'lib/l10n/app_en.arb').read_text())
...
watch = json.loads((root / 'ios/PomodoistWatch/Localizable.xcstrings').read_text())['strings']
...
resources = root / 'apple/Localization'
native_sets = []
for locale in ['pt-BR', 'ja', 'ko']:
