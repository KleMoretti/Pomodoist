...
class DesktopUpdatePopup extends ConsumerWidget {
  const DesktopUpdatePopup({super.key});
                    ...
                    children: [
                      ...
                      if (offer == null)
                        ShadButton.outline(
                          ...
                          onPressed: controller.busy
                              ? null
                              : () => unawaited(actions.check(manual: true)),
            ...
            SettingsRow(
              ...
              control: Align(
                ...
                child: ShadButton.outline(
                  ...
                  enabled: !controller.busy,
                  onPressed: () => unawaited(actions.check(manual: true)),
