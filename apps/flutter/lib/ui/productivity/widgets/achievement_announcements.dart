...
import 'package:pomodoist/ui/productivity/view_models/achievement_announcement_view_model.dart';
...
class AchievementAnnouncementBridge extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.watch(achievementAnnouncementBridgeViewModelProvider);
...
class _AchievementAnnouncementSlotState
  ...
  Widget build(BuildContext context) {
    final item = ref.watch(
      achievementAnnouncementViewModelProvider(widget.presentation),
    );
  ...
  void _dismissCurrent() {
    ...
    ref
        .read(
          achievementAnnouncementViewModelProvider(
            widget.presentation,
          ).notifier,
        )
        .dismissCurrent();
