...
extension _VoiceQuickAddHostPanel on _VoiceQuickAddHostState {
    ...
    return Row(
      children: [
        ...
        ShadSwitch(
          ...
          onChanged: _voice.motionActive ? null : _voiceActions.setSmartMode,
        ),
        const Spacer(),
        if (_voice.status == VoiceCaptureStatus.recording)
          Text(
            _recordingTimeLabel,
      ...
      children: [
        ...
        if (_voice.needsPermissionRequest || _voice.settingsDestination != null)
          OutlinedButton.icon(
            ...
            onPressed: _voice.canStart ? _voiceActions.recoverAccess : null,
        ...
        if (_voice.canUseCloudFallback)
          OutlinedButton.icon(
            ...
            onPressed: _voice.canStart
                ? _voiceActions.useCloudTranscription
                : null,
        ...
        if (_error != null &&
          ...
          TextButton.icon(
            onPressed: () =>
                _voiceActions.decomposeTranscript(_voice.transcript),
            icon: const Icon(LucideIcons.rotateCw),
  ...
  String _statusLabel(BuildContext context) {
    ...
    return switch (_voice.status) {
      VoiceCaptureStatus.idle => l10n.voiceStatusIdle,
      VoiceCaptureStatus.requestingPermission =>
        l10n.voiceStatusRequestingPermission,
      VoiceCaptureStatus.recording => l10n.voiceStatusRecording,
      VoiceCaptureStatus.transcribing => l10n.voiceStatusTranscribing,
      VoiceCaptureStatus.canceled => l10n.voiceStatusCanceled,
      VoiceCaptureStatus.unsupportedPlatform => l10n.voiceStatusUnsupported,
      VoiceCaptureStatus.error => l10n.voiceStatusError,
  ...
  String get _recoveryLabel {
    ...
    return switch (_voice.settingsDestination) {
      VoiceAccessSettings.microphone => l10n.voiceOpenMicrophoneSettings,
      VoiceAccessSettings.speech => l10n.voiceOpenSpeechSettings,
      VoiceAccessSettings.dictation => l10n.voiceEnableDictation,
